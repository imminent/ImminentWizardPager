...
import com.imminentmeals.android.annotations.Beta;
 ...
 * @since 10.0
 */
@Beta @ParametersAreNonnullByDefault
public abstract class Optional<T> implements Serializable {
  ...
  /**
   * If {@code nullable_reference} is non-null, returns an {@code Optional} instance containing
   * that
   * reference; otherwise returns {@link Optional#absent}.
   */
  public static <T> Optional<T> fromNullable(@Nullable T nullable_reference) {
    return (nullable_reference == null)? Optional.<T>absent() : new Present<>(nullable_reference);
  }
  ...
  /**
   * Returns this {@code Optional} if it has a value present; {@code second_choice}
   * otherwise.
   */
  public abstract Optional<T> or(Optional<? extends T> second_choice);
